...
export const COUNTRIES = {
  ...
  TN: 'Tunisia', TR: 'Türkiye', TM: 'Turkmenistan', TC: 'Turks and Caicos Islands',
  ...
  // Custom aliases for nations without ISO alpha-2 codes
  EN: 'England',
  XS: 'Scotland',
}
...
export const getFlagUrl = (code) => {
  ...
  const flagCode = upper === 'EN' ? 'gb-eng' : upper === 'XS' ? 'gb-sct' : code.toLowerCase()
